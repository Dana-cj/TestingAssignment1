   ...
   private static  boolean formatObserved = false;
    public static void main(String[] args) {
        ...
        while (!formatObserved) {
            ...
            Unit finalUnit = getFinalUnit(expression, unit);
            calculateDistance(expression, finalUnit);
        }
    }
    ...
    static Unit getFinalUnit(String expression, Unit unit) {
         expression= getExpression(expression);
        if (unit == null) {
            List<String> listOfComputations = getValuesFromExpression(expression);
    ...
    static List<String> getValuesFromExpression(String expression) {
        expression= getExpression(expression);
